...
<div id = "content" class="clearfix">
	...
	<div class="kotak-putih small-padding">
		...
		<h5>Ulasan Menu</h5>
		{!! Form::hidden('size', sizeof($id_name)) !!}
		@foreach($id_name as $keymenu=> $valuemenu)
			<div class="new_ulasan">
		        ...
		        <br><br>
		        {!! Form::label(App\Menu::find($keymenu)->name)!!}
				{!! Form::hidden('id'.$valuemenu, $keymenu) !!}
				{!! Form::textarea('deskripsi'.$valuemenu, null,
		                        array('required', 'class'=>'form-control','rows'=>4, 'placeholder'=>'Tuliskan ulasan layanan Anda di sini')) !!}
				<div class="stars">
